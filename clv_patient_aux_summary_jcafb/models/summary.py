...
class PatientAux(models.Model):
    ...
    def _patient_aux_summary_setup(self, dir_path, file_name):
        ...
        for patient_aux in self:
            ...
            for summary_template in summary_templates:
                ...
                if summary.id is False:
                    ...
                    summary_values['res_id'] = patient_aux.id
                ...
                patient_aux.summary_id = summary.id
            ...
            summary._patient_aux_summary_export_xls(summary, patient_aux, dir_path, file_name)


class Summary(models.Model):
    _inherit = 'clv.summary'

    def _patient_aux_summary(self, summary, model_object):
    ...
    def _patient_aux_summary_export_xls(self, summary, model_object, dir_path, file_name):
        ...
        row_nr += 1
        row = sheet.row(row_nr)
        row.write(0, 'Patient (Aux) Categories:')
